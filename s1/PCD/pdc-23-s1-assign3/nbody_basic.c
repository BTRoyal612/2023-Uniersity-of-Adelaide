 ...
 *           all the forces.
 *
 * Compile:  gcc -g -Wall -fopenmp -o nbody_basic nbody_basic.c -lm
 *           To turn off output except for timing results, define NO_OUTPUT
 *           To get verbose output, define DEBUG
 *
 * Run:      ./nbody_basic <number of threads> <number of particles>
...
/* In this version of the program (nbody_basic.c), all inner 
